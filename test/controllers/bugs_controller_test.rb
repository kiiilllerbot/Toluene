...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post bugs_url, params: { bug: { body: @bug.body, title: @bug.title, user_id: @bug.user_id } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { body: @bug.body, title: @bug.title, user_id: @bug.user_id } }
